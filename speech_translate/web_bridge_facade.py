...
_FORWARDED_METHODS: dict[str, tuple[str, str]] = {
    ...
    "_log_startup_marker": ("main_window_controller", "log_startup_marker"),
    "mark_startup": ("main_window_controller", "mark_startup"),
    "show_main_window": ("main_window_controller", "show_main_window"),
    "_save_main_window_geometry": ("main_window_controller", "save_main_window_geometry"),
    ...
    "_resolve_export_dir": ("system_settings_controller", "resolve_export_dir"),
    "_resolve_log_dir": ("system_settings_controller", "resolve_log_dir"),
    "_resolve_selenium_chrome_user_data_dir": ("system_settings_controller", "resolve_selenium_chrome_user_data_dir"),
    ...
    "_build_main_ui": ("state_view_builder", "build_main_ui"),
    "_build_record_device_ui": ("state_view_builder", "build_record_device_ui"),
    "_build_record_ui": ("state_view_builder", "build_record_ui"),
    "_build_about": ("state_view_builder", "build_about"),
    "_build_audio_source_options": ("state_view_builder", "build_audio_source_options"),
    "get_audio_source_options": ("state_view_builder", "get_audio_source_options"),
    "_resolve_model_dir": ("model_manager_controller", "resolve_model_dir"),
    "_get_model_manager_keys": ("model_manager_controller", "get_model_manager_keys"),
    "_normalize_model_key": ("model_manager_controller", "normalize_model_key"),
    "_normalize_engine_name": ("model_manager_controller", "normalize_engine_name"),
    "_is_model_available_for_backend": ("model_manager_controller", "is_model_available_for_backend"),
    "_verify_model_status": ("model_manager_controller", "verify_model_status"),
    "_cache_model_status": ("model_manager_controller", "cache_model_status"),
    "_estimate_total_whisper_bytes": ("model_manager_controller", "estimate_total_whisper_bytes"),
    "_build_model_manager_state": ("model_manager_controller", "build_model_manager_state"),
    "_build_runtime_model_state": ("model_manager_controller", "build_runtime_model_state"),
    ...
    "_wait_recording_idle": ("recording_controller", "wait_recording_idle"),
    ...
    "_build_import_ui": ("import_queue_controller", "build_import_ui"),
    "_get_full_display_queue": ("import_queue_controller", "get_full_display_queue"),
