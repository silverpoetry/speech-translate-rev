...
if getattr(sys, "frozen", False):
    dir_runtime: str = os.path.abspath(
        os.path.join(os.environ.get("LOCALAPPDATA", os.path.expanduser("~")), "Speech Translate Rev")
    )
else:
    dir_runtime = dir_project

dir_user: str = os.path.abspath(os.path.join(dir_runtime, "_user"))
dir_temp: str = os.path.abspath(os.path.join(dir_runtime, "temp"))
dir_debug: str = os.path.abspath(os.path.join(dir_runtime, "debug"))
dir_log: str = os.path.abspath(os.path.join(dir_runtime, "log"))
dir_assets: str = os.path.abspath(os.path.join(dir_project, "assets"))
dir_export: str = os.path.abspath(os.path.join(dir_runtime, "export"))
