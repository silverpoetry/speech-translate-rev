...
OutputDir=dist
OutputBaseFilename=SpeechTranslateRev
...
[Files]
Source: "build\SpeechTranslateRev {#MyAppVersion}{#EnvName}\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "build\SpeechTranslateRev {#MyAppVersion}{#EnvName}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
